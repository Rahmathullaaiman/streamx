...
<Card className="card2">
      <Card.Img variant="top" className='cardimg2' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU6XHo7VT96rdfY8d8zcZn1WEj_Hi2wtvsqg&s" alt='no image'  height={'140px'}
    width={'300px'} />
